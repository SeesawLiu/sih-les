...
namespace com.Sconit.Web.Controllers.ACC
{
    ...
    public class AuthorizationBaseController : WebAppBaseController
    {
        ...
        {
            IList<PermissionCategory> permissionCategoryList = this.genericMgr.FindAll<PermissionCategory>(selectPermissionCategoryStatement, permissionCategoryType);
        ...
        protected PermissionCategory Prepare4AssignPermissions()
        {
            ...
            IList<PermissionCategory> permissionCategoryList = this.genericMgr.FindAll<PermissionCategory>(selectPermissionCategoryStatement, codeDetailList[0].Value);
            if (permissionCategoryList == null)
            {
                permissionCategoryList = new List<PermissionCategory>();
            }
