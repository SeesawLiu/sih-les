...
{
    [SconitAuthorize]
    public class SAPItemController : WebAppBaseController
    {
        public SAPItemController()
        {
        ...
        public ActionResult Index(SearchModel searchModel)
        {
            ...
            string sql = @"select top " + MaxRowSize +
                @" e.* from SAP_Item e  where e.IOStatus = @p0 and e.InboundDate > @p1 and e.InboundDate < @p2  ";
