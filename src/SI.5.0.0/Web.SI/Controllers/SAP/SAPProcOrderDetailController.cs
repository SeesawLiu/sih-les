...
{
    [SconitAuthorize]
    public class SAPProcOrderDetailController : WebAppBaseController
    {
        public SAPProcOrderDetailController()
        {
        ...
        public ActionResult Index(SearchModel searchModel)
        {
            ...
            string sql = @"select top " + MaxRowSize +
                @" e.* from SAP_ProcOrderDetail e  where e.Status = @p0 and e.CreateDate > @p1 and e.CreateDate < @p2  ";
