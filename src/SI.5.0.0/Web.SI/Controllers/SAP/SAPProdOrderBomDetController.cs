...
namespace com.Sconit.Web.Controllers.SI.SAP
{
    ...
    public class SAPProdOrderBomDetController : WebAppBaseController
    {
        public SAPProdOrderBomDetController()
        {
        ...
        public ActionResult Index(SearchModel searchModel)
        {
            ...
            string sql = @"select top " + MaxRowSize +
                @" e.* from SAP_ProdOrderBomDet e where e.Status = @p0 and e.CreateDate > @p1 and e.CreateDate < @p2  ";
