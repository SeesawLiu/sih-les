...
namespace com.Sconit.Web.Controllers.SI.SAP
{
    ...
    public class SAPSupplierController : WebAppBaseController
    {
        public SAPSupplierController()
        {
        ...
        public ActionResult Index(SearchModel searchModel)
        {
            ...
            string sql = @"select top " + MaxRowSize + 
                " e.* from SAP_Supplier e  where e.IOStatus = @p0 and e.InboundDate > @p1 and e.InboundDate < @p2 ";
