...
using com.Sconit.WebService.SAP;
...
namespace com.Sconit.Web.Controllers.SI.SAP
{
    public class SAPTransController : WebAppBaseController
    {
        ...
        public ActionResult _AjaxListInvLoc(string FRBNR, string SGTXT)
        {
            ...
            IList<InvLoc> InvLocList = genericMgr.FindAll<InvLoc>(hql);
        ...
        public ActionResult ManuallyReExchangeMoveType()
        {
            try
            {
                //transMgr.ManuallyReExchangeMoveType();
