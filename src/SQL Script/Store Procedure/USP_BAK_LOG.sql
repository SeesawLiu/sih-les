...
BEGIN
	BEGIN TRY
		...
		WHILE EXISTS(SELECT * FROM LOG_DeleteVanProdOrder WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_DistributionRequisition WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_GenJITOrder WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_GenKBOrder WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_GenOrder4VanProdLine WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_GenProductOrder WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_GenSequenceOrder WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_GenVanProdOrder WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_OpRefBalanceChange WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_OrderTrace WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_OrderTraceDet WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_ProdOrderPauseResume WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_RunLeanEngine WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_SeqOrderChange WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_SnapshotFlowDet4LeanEngine WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_VanOrderBomTrace WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM LOG_VanOrderTrace WHERE CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM FIS_CancelReceiptMaster WHERE IsCreateDat = 1 and CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM FIS_CreateBarCode WHERE IsCreateDat = 1 and CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM FIS_CreateIpDAT WHERE IsCreateDat = 1 and TIME_STAMP1<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM FIS_CreateProcurementOrderDAT WHERE IsCreateDat = 1 and CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM FIS_CreateSeqOrderDAT WHERE IsCreateDat = 1 and CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM FIS_ItemStandardPack WHERE IsCreateDat = 1 and CreateDate<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM FIS_LesINLog WHERE IsCreateDat = 1 and HandTime<@BakDate)
		BEGIN
		...
		WHILE EXISTS(SELECT * FROM FIS_YieldReturn WHERE IsCreateDat = 1 and CreateDate<@BakDate)
		BEGIN
