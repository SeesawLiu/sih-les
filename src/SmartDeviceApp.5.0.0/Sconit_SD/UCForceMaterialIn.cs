...
{
    public partial class UCForceMaterialIn : UserControl
    {
        ...
        private static UCForceMaterialIn ucForceMaterialIn;
        ...
        public static UCForceMaterialIn UCForceMaterialIns(User user)
        {
            if (ucForceMaterialIn == null)
            {
                lock (obj)
                {
                    if (ucForceMaterialIn == null)
                    {
                        ucForceMaterialIn = new UCForceMaterialIn(user);
                    }
                }
            }

            ucForceMaterialIn.lblMessage.Text = "请扫描Van号";
            return ucForceMaterialIn;
        }
        ...
        private void ScanBarCode()
        {
            ...
            else 
            {
                ...
                this.smartDeviceService.ScanQualityBarCode(this.traceCode, barCode, null, true,true, this.user.Code);
