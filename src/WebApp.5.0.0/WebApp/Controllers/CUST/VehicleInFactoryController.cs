...
namespace com.Sconit.Web.Controllers.CUST
{
    public class VehicleInFactoryController : WebAppBaseController
    {
        ...
        [HttpPost]
        [SconitAuthorize(Permissions = "Url_VehicleInFactory_New")]
        public JsonResult IpNoScan(string ipNo)
        {
        ...
        {
            VehicleInFactoryMaster vehicleInFactoryMaster = base.genericMgr.FindById<VehicleInFactoryMaster>(orderNo);
        ...
        {
            IList<VehicleInFactoryDetail> vehicleInFactoryDetailList = base.genericMgr.FindAll<VehicleInFactoryDetail>("from VehicleInFactoryDetail where OrderNo = ? ", orderNo);
