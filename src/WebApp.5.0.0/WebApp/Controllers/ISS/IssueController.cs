...
namespace com.Sconit.Web.Controllers.ISS
{
    ...
    public class IssueController : WebAppBaseController
    {
        ...
        {
            IList<IssueDetail> issueDetailList = base.genericMgr.FindAll<IssueDetail>(selectStatementByCode, code);
        ...
        public ActionResult Start(string id)
        {
            ...
            {
                IssueMaster issue = base.genericMgr.FindById<IssueMaster>(id);
                if (issue == null)
                {
                    return HttpNotFound();
                }
        ...
        public ActionResult _IssueDetailsHierarchyAjax(string issueCode)
        {
            IList<IssueDetail> issueDetailList =
                base.genericMgr.FindAll<IssueDetail>("select i from IssueDetail as i where i.IssueCode = ?", issueCode);
        ...
        public ActionResult Delete(string id)
        {
            ...
            else
            {
                ...
                {
                    base.genericMgr.DeleteById<IssueMaster>(id);
