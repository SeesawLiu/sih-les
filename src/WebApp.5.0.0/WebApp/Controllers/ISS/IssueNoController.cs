...
namespace com.Sconit.Web.Controllers.ISS
{
    ...
    public class IssueNoController : WebAppBaseController
    {
        ...
        /// 
        /// </summary>
        private static string codeDuiplicateVerifyStatement = @"select count(*) from IssueNo as it where Code = ?";
        ...
        public ActionResult Edit(string id)
        {
            ...
            {
                IssueNo issueNo = base.genericMgr.FindById<IssueNo>(id);
                return View(issueNo);
            }
        }
        ...
        public ActionResult Delete(string id)
        {
            ...
            {
                base.genericMgr.DeleteById<IssueNo>(id);
        ...
        private SearchStatementModel PrepareSearchStatement(GridCommand command, IssueNoSearchModel searchModel)
        {
            ...
            if (!string.IsNullOrWhiteSpace(searchModel.IssueTypeCode))
            {
                HqlStatementHelper.AddEqStatement("IssueType.Code", searchModel.IssueTypeCode, "it", ref whereStatement, param);
            }
