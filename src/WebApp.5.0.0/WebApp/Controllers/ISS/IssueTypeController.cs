...
namespace com.Sconit.Web.Controllers.ISS
{
    ...
    public class IssueTypeController : WebAppBaseController
    {
        ...
        public ActionResult Edit(string id)
        {
            ...
            {
                IssueType issueType = base.genericMgr.FindById<IssueType>(id);
                return View(issueType);
            }
        }
        ...
        public ActionResult Delete(string id)
        {
            ...
            {
                base.genericMgr.Delete(string.Format("from IssueNo as isn where isn.IssueType.Code='{0}'", id));

                base.genericMgr.DeleteById<IssueType>(id);
