...
namespace com.Sconit.Web.Controllers.MD
{
    ...
    public class CurrencyController : WebAppBaseController
    {
        ...
        public ActionResult New(Currency currency)
        {
            ...
            {
                if (base.genericMgr.FindAll<long>(duiplicateVerifyStatement, new object[] { currency.Code })[0] > 0)
                {
                    SaveErrorMessage(Resources.ErrorMessage.Errors_Existing_Code, currency.Code);
                }
                else
                {
        ...
        public ActionResult Edit(string id)
        {
            ...
            {
                Currency currency = base.genericMgr.FindById<Currency>(id);
                return View(currency);
            }
        }
        ...
        public ActionResult Delete(string id)
        {
            ...
            {
                base.genericMgr.DeleteById<Currency>(id);
