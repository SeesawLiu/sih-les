...
namespace com.Sconit.Web.Controllers.MD
{
    ...
    {       
        ...
        public ActionResult New(FinanceCalendar financeCalendar)
        {
            ...
            {
                if (base.genericMgr.FindAll<long>(duiplicateVerifyStatement, new object[] { financeCalendar.Id })[0] > 0)
                {
                ...
                else
                {
                    ...
                    {
                        base.genericMgr.Create(financeCalendar);
        ...
        public ActionResult Edit(int? id)
        {
            ...
            {
                FinanceCalendar financeCalendar = base.genericMgr.FindById<FinanceCalendar>(id);
                return View(financeCalendar);
            }
        }
        ...
        public ActionResult Edit(FinanceCalendar financeCalendar)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    base.genericMgr.Update(financeCalendar);
        ...
        public ActionResult Delete(int? id)
        {
            ...
            {
                base.genericMgr.DeleteById<FinanceCalendar>(id);
