...
namespace com.Sconit.Web.Controllers.MD
{
    ...
    public class ItemCategoryController : WebAppBaseController
    {
        ...
        public ActionResult Edit(string id)
        {
            ...
            {
                ItemCategory itemCategory = base.genericMgr.FindById<ItemCategory>(id);
                if (!string.IsNullOrEmpty(itemCategory.ParentCategory))
                {
                    itemCategory.ParentCategoryDescription = base.genericMgr.FindById<ItemCategory>(itemCategory.ParentCategory).Description;
                }
                return View(itemCategory);
            }
        }
        ...
        public ActionResult Delete(string id)
        {
            ...
            {
                base.genericMgr.DeleteById<ItemCategory>(id);
