...
{
    public class ProdLineStandardWorkingCalendarController : WebAppBaseController
    {
        /// <summary>
        ...
        /// </summary>
        private static string duiplicateVerifyCountStatement = @"select count(*) from StandardWorkingCalendar as swc where swc.ProdLine = ? and swc.DayOfWeek = ? ";
        private static string duiplicateVerifyStatement = @"select swc from StandardWorkingCalendar as swc where swc.ProdLine = ? and swc.DayOfWeek = ? ";
        ...
        [SconitAuthorize(Permissions = "Url_ProdLineStandardWorkingCalendar_View")]
        ...
        public ActionResult List(GridCommand command, StandardWorkingCalendarSearchModel searchModel)
        {
            ...
            var q = user.UrlPermissions.Where(p => p.Contains("Url_ProdLineStandardWorkingCalendar_Edit")).ToList();
        ...
        [SconitAuthorize(Permissions = "Url_ProdLineStandardWorkingCalendar_Edit")]
        ...
        public ActionResult New(StandardWorkingCalendar standardWorkingCalendar)
        {
            ...
            {
                if (base.genericMgr.FindAll<long>(duiplicateVerifyCountStatement, new object[] { standardWorkingCalendar.ProdLine, standardWorkingCalendar.DayOfWeek })[0] > 0)
                {
                    this.FillCodeDetailDescription(standardWorkingCalendar);
                    SaveErrorMessage(Resources.PRD.StandardWorkingCalendar.Errors_Existing_DayOfWeekInTheRegionProdLine, standardWorkingCalendar.ProdLine, standardWorkingCalendar.DayOfWeekDescription);
                }
                else
                {
                    standardWorkingCalendar.Category = CodeMaster.WorkingCalendarCategory.ProdLine;
        ...
        public ActionResult Edit(StandardWorkingCalendar standardWorkingCalendar)
        {
            if (ModelState.IsValid)
            {
                var items = base.genericMgr.FindAll<StandardWorkingCalendar>(duiplicateVerifyStatement, new object[] { standardWorkingCalendar.ProdLine, standardWorkingCalendar.DayOfWeek });
        ...
        [SconitAuthorize(Permissions = "Url_ProdLineStandardWorkingCalendar_Delete")]
        ...
        private SearchStatementModel PrepareSearchStatement(GridCommand command, StandardWorkingCalendarSearchModel searchModel)
        {
            ...
            HqlStatementHelper.AddEqStatement("Category", (int)CodeMaster.WorkingCalendarCategory.ProdLine, "swc", ref whereStatement, param);
            HqlStatementHelper.AddEqStatement("ProdLine", searchModel.SearchRegion, "swc", ref whereStatement, param);
            ...
            {
                sortingStatement = " order by swc.ProdLine asc, swc.DayOfWeek asc ";
            }
