...
{
    public class SpecialTimeController : WebAppBaseController
    {
        #region Properties
        ...
        private static string selectspecialTimeByRegionStatement = @"select s from SpecialTime as s where s.Region = ?";
        ...
        [HttpGet]
        [SconitAuthorize(Permissions = "Url_SpecialTime_RestView")]
        ...
        /// </summary>
        /// <returns>rediret view</returns>
        [SconitAuthorize(Permissions = "Url_SpecialTime_RestEdit")]
        ...
        public ActionResult New(SpecialTime specialTime)
        {
            ...
            {
                if (string.IsNullOrWhiteSpace(specialTime.Region))
                {
                    SaveErrorMessage(Resources.PRD.SpecialTime.SpecialTime_Region);
                }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                SaveErrorMessage(Resources.PRD.SpecialTime.Errors_CoverTheRegion, new string[] { coverdSpecialTime.StartTime.ToString(), coverdSpecialTime.EndTime.ToString() });
                            }
                            else
                            {
                                try
                                {
                                    ...
                                    //this.workingCalendarMgr.AddSpecialTime(specialTime);
        ...
        [SconitAuthorize(Permissions = "Url_SpecialTime_RestDelete")]
        public ActionResult Delete(int? id)
        {
            ...
            else
            {
                try
                {
                    ...
                    //this.workingCalendarMgr.DeleteSpecialTime(specialTime);
        ...
        [HttpGet]
        [SconitAuthorize(Permissions = "Url_SpecialTime_WorkView")]
        ...
        /// </summary>
        /// <returns>rediret view</returns>
        [SconitAuthorize(Permissions = "Url_SpecialTime_WorkEdit")]
        ...
        [SconitAuthorize(Permissions = "Url_SpecialTime_WorkDelete")]
