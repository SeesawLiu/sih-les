namespace com.Sconit.Web.Controllers.PRD
{
    ...
    /// </summary>
    public class VanProductLineMapController : WebAppBaseController
    {
        /// <summary>
        ...
        [SconitAuthorize(Permissions = "Url_CUST_VanProductLineMap_View")]
        public ActionResult Index()
        {
            return View();
        }

        [SconitAuthorize(Permissions = "Url_CUST_VanProductLineMap_Edit")]
