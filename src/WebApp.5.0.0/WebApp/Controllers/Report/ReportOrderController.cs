namespace com.Sconit.Web.Controllers.Report
{
    ...
    {
        IGenericMgr genericMgr { get; set; }
        ...
        public ActionResult _OrderMasterHierarchyAjax()
        {
            ...
            if (searchModel != null)
            {
                ...
                {
                    hql += whereStatement;
                    orderMasterList = this.genericMgr.FindAll<OrderMaster>(hql, param);
                }
            }
            orderMasterList = this.genericMgr.FindAll<OrderMaster>(hql);
        ...
        public ActionResult _OrdersDetailHierarchyAjax(string orderNo)
        {
            IList<OrderDetail> orderDetailList =
                this.genericMgr.FindAll<OrderDetail>("select o from OrderDetail as o where o.OrderNo = ?", orderNo);
        ...
        public ActionResult _OrderBomDetailsHierarchyAjax(int orderDetailId)
        {
            IList<OrderBomDetail> orderDetaiBomlList =
                this.genericMgr.FindAll<OrderBomDetail>("select o from OrderBomDetail as o where o.OrderDetailId = ?", orderDetailId);
