...
{
    public class DistributionFlowController : WebAppBaseController
    {
        ...
        public DistributionFlowController()
        {
        }

        [SconitAuthorize(Permissions = "Url_DistributionFlow_View")]
        ...
        public ActionResult New(FlowMaster flow)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    base.SaveErrorMessage(Resources.ErrorMessage.Errors_Common_FieldRequired, Resources.SCM.FlowMaster.FlowMaster_DistributionPartyFrom);
                }
                else if (string.IsNullOrEmpty(flow.PartyTo))
                {
                    base.SaveErrorMessage(Resources.ErrorMessage.Errors_Common_FieldRequired, Resources.SCM.FlowMaster.FlowMaster_DistributionPartyTo);
                }
        ...
        [SconitAuthorize(Permissions = "Url_DistributionFlow_Delete")]
        ...
        {
            string whereStatement = " where f.Type=3 ";
